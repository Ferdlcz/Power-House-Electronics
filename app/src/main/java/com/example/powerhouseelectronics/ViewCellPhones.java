...
public class ViewCellPhones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("");
        setContentView(R.layout.activity_view_cell_phones);
    ...
    private void mostrarPhones(String jsonData) {
        ...
        if (phoneList != null && !phoneList.isEmpty()) {
            for (PhoneResponse cellPhones : phoneList) {
                ...
                CardView phoneCard = ProductsFilter.createCardPhone(this, cellPhones);
    ...
    public class PhoneResponseList {
        ...
        private List<ViewCellPhones.PhoneResponse> phones;

        public List<ViewCellPhones.PhoneResponse> getPhones() {
            return phones;
        }

        public void setProducts(List<ViewCellPhones.PhoneResponse> phones) {
            this.phones = phones;
        }
    }
    ...
    private void GoProfile() {
        Intent intent = new Intent(ViewCellPhones.this, Profile.class);
        startActivity(intent);
    }

    private void GoCarrito (){
        Intent intent = new Intent(ViewCellPhones.this, Carrito.class);
        startActivity(intent);
    }
